        ...
        >
          <defs>
            <linearGradient id="tropicalGradient1" x1="0%" y1="0%" x2="100%" y2="100%">
              <stop offset="0%" stopColor="currentColor" stopOpacity="0.3" className="text-purple-400 dark:text-purple-300" />
          ...
          <g filter="url(#tropicalBlur)" className="text-purple-500/30 dark:text-purple-400/20">
            <path
        ...
        >
          <defs>
            <linearGradient id="tropicalGradient2" x1="100%" y1="0%" x2="0%" y2="100%">
              ...
              <stop offset="100%" stopColor="currentColor" stopOpacity="0" className="text-purple-600 dark:text-purple-500" />
            </linearGradient>
          ...
          <g filter="url(#tropicalBlur2)" className="text-violet-500/20 dark:text-purple-400/15">
            <path
