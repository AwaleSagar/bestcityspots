...
export default function CityVitals({ data }: CityVitalsProps) {
  const getAqiColor = (aqi: number) => {
    switch (aqi) {
      case 1:
        return "text-emerald-700 border-emerald-600/20 bg-emerald-500/8 dark:text-emerald-300";
      case 2:
        return "text-lime-700 border-lime-600/20 bg-lime-500/8 dark:text-lime-300";
      case 3:
  ...
  return (
    <div className="atlas-panel rounded-[1.4rem] p-5 shadow-xl sm:rounded-[1.7rem] sm:p-6 md:rounded-[2rem]">
      <div className="mb-6 flex items-center justify-between">
        ...
        <span className="text-muted text-[8px] font-bold uppercase">
          Updated{" "}
      ...
      <div className="grid grid-cols-2 gap-4">
        ...
        <div className="space-y-1">
          <div className="text-muted flex items-center gap-2">
            ...
            <span className="text-[9px] font-bold tracking-wider uppercase">Temperature</span>
          </div>
        ...
        <div className="space-y-1">
          <div className="text-muted flex items-center gap-2">
            ...
            <span className="text-[9px] font-bold tracking-wider uppercase">Air Quality</span>
          </div>
          <div
      ...
      <div className="border-line mt-6 flex gap-6 border-t pt-4">
        <div className="flex items-center gap-2">
          ...
          <div>
            <span className="text-muted block text-[8px] font-black uppercase">Humidity</span>
        ...
        <div className="flex items-center gap-2">
          ...
          <div>
            <span className="text-muted block text-[8px] font-black uppercase">Wind</span>
            <span className="text-xs font-bold">
              {Math.round(data.wind_speed)} <span className="text-[8px] opacity-60">km/h</span>
            </span>
          </div>
        </div>
      </div>
